...
public class KeyguardSliceProviderDerpFest extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    private static final String TAG = "KeyguardSliceProviderDerpFest";
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        AddShadowTask(KeyguardSliceProviderDerpFest KeyguardSliceProviderderpfest, SmartSpaceCard smartSpaceCard) {
            this.mProviderReference = new WeakReference<>(KeyguardSliceProviderderpfest);
            this.mWeatherCard = smartSpaceCard;
            this.mBlurRadius = KeyguardSliceProviderderpfest.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            ...
            synchronized (this) {
                ...
                KeyguardSliceProviderderpfest = this.mProviderReference.get();
            }

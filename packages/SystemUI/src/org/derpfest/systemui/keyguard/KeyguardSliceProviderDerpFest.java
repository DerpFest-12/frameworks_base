...
public class KeyguardSliceProviderDerpFest extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<KeyguardSliceProviderDerpFest> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(KeyguardSliceProviderDerpFest keyguardSliceProviderDerpFest, SmartSpaceCard smartSpaceCard) {
            mProviderReference = new WeakReference<>(keyguardSliceProviderDerpFest);
            mWeatherCard = smartSpaceCard;
            mBlurRadius = keyguardSliceProviderDerpFest.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            KeyguardSliceProviderDerpFest keyguardSliceProviderDerpFest;
            synchronized (this) {
                mWeatherCard.setIcon(bitmap);
                keyguardSliceProviderDerpFest = (KeyguardSliceProviderDerpFest) mProviderReference.get();
            }
            if (keyguardSliceProviderDerpFest != null) {
                keyguardSliceProviderDerpFest.notifyChange();
            }
        }
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("KeyguardSliceProviderDerpFest#onBindSlice");
        Slice slice;

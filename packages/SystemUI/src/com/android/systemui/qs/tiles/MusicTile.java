    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        if (mActive) {
            ...
            state.label = mMetadata.trackTitle != null
                ? mMetadata.trackTitle : mContext.getString(R.string.quick_settings_music_label);
            state.secondaryLabel = mContext.getString(R.string.quick_settings_music_pause);
            state.state = Tile.STATE_ACTIVE;
        } else {
            state.icon = ResourceIcon.get(R.drawable.ic_qs_media_play);
            state.label = mContext.getString(R.string.quick_settings_music_label);
            state.secondaryLabel = mContext.getString(R.string.quick_settings_music_play);
